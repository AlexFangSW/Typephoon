    ...
    <div className={styles.container}>
      <div className={styles.attribution_container}>
        ...
        <div className={styles.attribution}>
          ...
          <a
            href="https://www.flaticon.com/free-icons/wireless-keyboard"
            title="wireless keyboard icons"
          >
            Wireless keyboard icons created by Freepik - Flaticon
          </a>
        </div>
        ...
        {/* gitbranch */}
        <div className={styles.attribution}>
          <Image src="/gitbranch.svg" alt="Git branch" width={35} height={35} />
          <div>
            Icon by <a href="https://freeicons.io/profile/3">icon king1</a> on{" "}
            <a href="https://freeicons.io">freeicons.io</a>
          </div>
        ...
        <div className={styles.attribution}>
          ...
          />
          <div>
            Icon by <a href="https://freeicons.io/profile/126253">ToZIcon</a> on{" "}
            <a href="https://freeicons.io">freeicons.io</a>
          </div>
        </div>
      </div>
